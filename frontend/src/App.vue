    ...
    <section class="mx-auto max-w-3xl">
      ...
      <div class="rounded-3xl border border-slate-800 bg-slate-900/70 p-8 shadow-2xl">
        <div class="mb-8 grid gap-3 text-sm text-slate-400 sm:grid-cols-3">
          <div class="rounded-xl bg-slate-950/70 px-4 py-3">AES-256-GCM</div>
          <div class="rounded-xl bg-slate-950/70 px-4 py-3">RSA-OAEP-256</div>
        ...
        <div
          v-if="result"
          class="mt-8 rounded-2xl border border-emerald-400/20 bg-emerald-400/5 p-5"
        >
